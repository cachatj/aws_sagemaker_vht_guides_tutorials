...
PRICE_DATA_BUCKET           = "###AWS_ACCOUNT_ID###-###APP_NAME###-###ENV_NAME###-equity-price-s3-glue-s3-data"
GLUE_SCRIPTS_BUCKET_NAME    = "###AWS_ACCOUNT_ID###-###APP_NAME###-###ENV_NAME###-glue-scripts"
GLUE_ROLE_NAME              = "###APP_NAME###-###ENV_NAME###-glue-role"
PRICE_DATA_FILE             = "s3://###AWS_ACCOUNT_ID###-###APP_NAME###-###ENV_NAME###-equity-price-s3-glue-s3-data/price.csv"
PRICE_ICEBERG_BUCKET        = "s3://###AWS_ACCOUNT_ID###-###APP_NAME###-###ENV_NAME###-equity-price-s3-glue-s3-iceberg/"

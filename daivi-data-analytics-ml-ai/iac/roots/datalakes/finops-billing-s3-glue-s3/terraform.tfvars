...
BILLING_DATA_BUCKET         = "###AWS_ACCOUNT_ID###-###APP_NAME###-###ENV_NAME###-finops-billing-s3-glue-s3-data"
GLUE_SCRIPTS_BUCKET_NAME    = "###AWS_ACCOUNT_ID###-###APP_NAME###-###ENV_NAME###-glue-scripts"
GLUE_ROLE_NAME              = "###APP_NAME###-###ENV_NAME###-glue-role"
BILLING_DATA_FILE           = "s3://###AWS_ACCOUNT_ID###-###APP_NAME###-###ENV_NAME###-finops-billing-s3-glue-s3-data/cost-and-usage-report-00001.csv.gz"
BILLING_ICEBERG_BUCKET      = "s3://###AWS_ACCOUNT_ID###-###APP_NAME###-###ENV_NAME###-finops-billing-s3-glue-s3-iceberg/"

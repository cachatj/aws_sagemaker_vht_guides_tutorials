...
def main():
    ...
    st.title("Data Analytics for Business User")
    st.markdown("<p class='small-header'>Data Analytics Conversational AI Assistant Powered by Amazon Bedrock</p>", unsafe_allow_html=True)
    params=app_sidebar()
